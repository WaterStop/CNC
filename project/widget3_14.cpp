...
void widget3_14::loadWorkInfo(int index)
{
    ...
    if(cur_work_mod==daojiao2)
    {
        ...
        ui->edit_5->setText(str);
        dir_1 = tem_val->chamfer2.zDir;
        dir_2 = tem_val->chamfer2.xDir;
        change_axisdir_icon();
    }
    else if(cur_work_mod==daojiao4)
    {
        ...
        ui->edit_5->setText(str);
        dir_1 = tem_val->chamfer4.zDir;
        dir_2 = tem_val->chamfer4.xDir;
        change_axisdir_icon();
    }
}
...
bool widget3_14::wedget3_14ToProcessList(MachineProcess* dealInterfaceData, s_chamferMode2* chamfer2, Ui::widget3_14* ui)
{
    ...
    else
    {
        if(modify_flg==1)
        {
            dealInterfaceData->changeNode(cur_Node, *chamfer2);
        }
        else  if (false == dealInterfaceData->addNode(*chamfer2))
        {
            return false;
        }
    }
...
bool widget3_14::wedget3_14ToProcessList(MachineProcess* dealInterfaceData, s_chamferMode4* chamfer4, Ui::widget3_14* ui)
{
    ...
    else
    {
        if(modify_flg==1)
        {
            dealInterfaceData->changeNode(cur_Node, *chamfer4);
        }
        else  if (false == dealInterfaceData->addNode(*chamfer4))
        {
            return false;
        }
    }
