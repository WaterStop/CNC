...
void widget3_7::loadWorkInfo(int index)
{
    ...
    if(cur_work_mod==daojiao1)
    {
        ...
        ui->edit_5->setText(str);
        dir_1 = tem_val->chamfer1.zDir;
        dir_2 = tem_val->chamfer1.xDir;
        change_axisdir_icon();
    }
    else if(cur_work_mod==daojiao3)
    {
        ...
        ui->edit_5->setText(str);
        dir_1 = tem_val->chamfer3.zDir;
        dir_2 = tem_val->chamfer3.xDir;
        change_axisdir_icon();
    }
}
...
bool widget3_7::wedget3_7ToProcessList(MachineProcess* dealInterfaceData, s_chamferMode1* chamfer1, Ui::widget3_7* ui)
{
    ...
    else
    {
        if(modify_flg==1)
        {
            dealInterfaceData->changeNode(cur_Node, *chamfer1);
        }
        else  if (false == dealInterfaceData->addNode(*chamfer1))
        {
            return false;
        }
    }
...
bool widget3_7::wedget3_7ToProcessList(MachineProcess* dealInterfaceData, s_chamferMode3* chamfer3, Ui::widget3_7* ui)
{
    ...
    else
    {
        if(modify_flg==1)
        {
            dealInterfaceData->changeNode(cur_Node, *chamfer3);
        }
        else  if (false == dealInterfaceData->addNode(*chamfer3))
        {
            return false;
        }
    }
