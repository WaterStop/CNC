/********************************************************************************
** Form generated from reading UI file 'widget3_12.ui'
**
...
#ifndef UI_WIDGET3_12_H
#define UI_WIDGET3_12_H
...
public:
    ...
    void setupUi(QWidget *widget3_12)
    {
        if (widget3_12->objectName().isEmpty())
            widget3_12->setObjectName(QString::fromUtf8("widget3_12"));
        widget3_12->resize(293, 430);
        frame = new QFrame(widget3_12);
...
"background-color: rgb(64, 86, 129);"));
        ...
        edit_7 = new MyLineEdit(frame);
        edit_7->setObjectName(QString::fromUtf8("edit_7"));
        edit_7->setGeometry(QRect(80, 330, 113, 31));
...
"background-color: rgb(64, 86, 129);"));
        ...
        retranslateUi(widget3_12);

        QMetaObject::connectSlotsByName(widget3_12);
    } // setupUi

    void retranslateUi(QWidget *widget3_12)
    {
        widget3_12->setWindowTitle(QCoreApplication::translate("widget3_12", "Form", nullptr));
...
namespace Ui {
    class widget3_12: public Ui_widget3_12 {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_WIDGET3_12_H
