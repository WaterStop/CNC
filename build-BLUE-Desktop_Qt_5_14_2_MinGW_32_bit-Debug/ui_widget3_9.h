/********************************************************************************
** Form generated from reading UI file 'widget3_9.ui'
**
...
#ifndef UI_WIDGET3_9_H
#define UI_WIDGET3_9_H
...
public:
    ...
    void setupUi(QWidget *widget3_9)
    {
        if (widget3_9->objectName().isEmpty())
            widget3_9->setObjectName(QString::fromUtf8("widget3_9"));
        widget3_9->resize(293, 430);
        frame = new QFrame(widget3_9);
...
"background-color: rgb(64, 86, 129);"));
        ...
        retranslateUi(widget3_9);

        QMetaObject::connectSlotsByName(widget3_9);
    } // setupUi

    void retranslateUi(QWidget *widget3_9)
    {
        widget3_9->setWindowTitle(QCoreApplication::translate("widget3_9", "Form", nullptr));
...
namespace Ui {
    class widget3_9: public Ui_widget3_9 {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_WIDGET3_9_H
