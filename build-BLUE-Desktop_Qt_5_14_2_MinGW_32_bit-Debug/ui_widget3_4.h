/********************************************************************************
** Form generated from reading UI file 'widget3_4.ui'
**
...
#ifndef UI_WIDGET3_4_H
#define UI_WIDGET3_4_H
...
public:
    ...
    void setupUi(QWidget *widget3_4)
    {
        if (widget3_4->objectName().isEmpty())
            widget3_4->setObjectName(QString::fromUtf8("widget3_4"));
        widget3_4->resize(293, 430);
        frame = new QFrame(widget3_4);
...
"background-color: rgb(64, 86, 129);"));
        ...
        retranslateUi(widget3_4);

        QMetaObject::connectSlotsByName(widget3_4);
    } // setupUi

    void retranslateUi(QWidget *widget3_4)
    {
        widget3_4->setWindowTitle(QCoreApplication::translate("widget3_4", "Form", nullptr));
...
namespace Ui {
    class widget3_4: public Ui_widget3_4 {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_WIDGET3_4_H
