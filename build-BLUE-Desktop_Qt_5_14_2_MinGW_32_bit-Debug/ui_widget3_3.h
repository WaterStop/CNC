/********************************************************************************
** Form generated from reading UI file 'widget3_3.ui'
**
...
#ifndef UI_WIDGET3_3_H
#define UI_WIDGET3_3_H
...
public:
    ...
    void setupUi(QWidget *widget3_3)
    {
        if (widget3_3->objectName().isEmpty())
            widget3_3->setObjectName(QString::fromUtf8("widget3_3"));
        widget3_3->resize(293, 430);
        QSizePolicy sizePolicy(QSizePolicy::Preferred, QSizePolicy::Preferred);
        sizePolicy.setHorizontalStretch(0);
        sizePolicy.setVerticalStretch(0);
        sizePolicy.setHeightForWidth(widget3_3->sizePolicy().hasHeightForWidth());
        widget3_3->setSizePolicy(sizePolicy);
        frame = new QFrame(widget3_3);
        ...
        sizePolicy1.setHeightForWidth(edit_4->sizePolicy().hasHeightForWidth());
        edit_4->setSizePolicy(sizePolicy1);
        QFont font;
...
"background-color: rgb(64, 86, 129);"));
        ...
        sizePolicy1.setHeightForWidth(edit_2->sizePolicy().hasHeightForWidth());
        edit_2->setSizePolicy(sizePolicy1);
        edit_2->setFont(font);
...
"background-color: rgb(64, 86, 129);"));
        ...
        sizePolicy1.setHeightForWidth(bt_l_2->sizePolicy().hasHeightForWidth());
        bt_l_2->setSizePolicy(sizePolicy1);
        edit_3 = new MyLineEdit(frame);
        edit_3->setObjectName(QString::fromUtf8("edit_3"));
        edit_3->setGeometry(QRect(70, 160, 113, 31));
        sizePolicy1.setHeightForWidth(edit_3->sizePolicy().hasHeightForWidth());
        edit_3->setSizePolicy(sizePolicy1);
        edit_3->setFont(font);
...
"background-color: rgb(64, 86, 129);"));
        ...
        sizePolicy1.setHeightForWidth(edit_5->sizePolicy().hasHeightForWidth());
        edit_5->setSizePolicy(sizePolicy1);
        edit_5->setFont(font);
...
"background-color: rgb(64, 86, 129);"));
        ...
        sizePolicy1.setHeightForWidth(bt_l_1->sizePolicy().hasHeightForWidth());
        bt_l_1->setSizePolicy(sizePolicy1);
        edit_1 = new MyLineEdit(frame);
        edit_1->setObjectName(QString::fromUtf8("edit_1"));
        edit_1->setGeometry(QRect(70, 60, 113, 31));
        sizePolicy1.setHeightForWidth(edit_1->sizePolicy().hasHeightForWidth());
        edit_1->setSizePolicy(sizePolicy1);
        edit_1->setFont(font);
        edit_1->setStyleSheet(QString::fromUtf8("color: rgb(255, 255, 255);;\n"
"background-color: rgb(64, 86, 129);\n"
"border-color: rgb(255, 5, 17);"));
        ...
        sizePolicy1.setHeightForWidth(bt_b_0->sizePolicy().hasHeightForWidth());
        bt_b_0->setSizePolicy(sizePolicy1);
        bt_close = new QPushButton(frame);
        bt_close->setObjectName(QString::fromUtf8("bt_close"));
        bt_close->setGeometry(QRect(240, 10, 20, 20));
        sizePolicy1.setHeightForWidth(bt_close->sizePolicy().hasHeightForWidth());
        bt_close->setSizePolicy(sizePolicy1);

        retranslateUi(widget3_3);

        QMetaObject::connectSlotsByName(widget3_3);
    } // setupUi

    void retranslateUi(QWidget *widget3_3)
    {
        widget3_3->setWindowTitle(QCoreApplication::translate("widget3_3", "Form", nullptr));
...
namespace Ui {
    class widget3_3: public Ui_widget3_3 {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_WIDGET3_3_H
