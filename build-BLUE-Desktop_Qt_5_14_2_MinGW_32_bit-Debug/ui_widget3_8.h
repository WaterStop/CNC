/********************************************************************************
** Form generated from reading UI file 'widget3_8.ui'
**
...
#ifndef UI_WIDGET3_8_H
#define UI_WIDGET3_8_H
...
public:
    ...
    void setupUi(QWidget *widget3_8)
    {
        if (widget3_8->objectName().isEmpty())
            widget3_8->setObjectName(QString::fromUtf8("widget3_8"));
        widget3_8->resize(293, 430);
        frame = new QFrame(widget3_8);
...
"background-color: rgb(64, 86, 129);"));
        ...
        retranslateUi(widget3_8);

        QMetaObject::connectSlotsByName(widget3_8);
    } // setupUi

    void retranslateUi(QWidget *widget3_8)
    {
        widget3_8->setWindowTitle(QCoreApplication::translate("widget3_8", "Form", nullptr));
...
namespace Ui {
    class widget3_8: public Ui_widget3_8 {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_WIDGET3_8_H
