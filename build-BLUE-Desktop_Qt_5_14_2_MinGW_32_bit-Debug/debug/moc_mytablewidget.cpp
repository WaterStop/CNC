...
#include <memory>
#include "../../project/mytablewidget.h"
...
QT_MOC_LITERAL(1, 14, 13), // "sigWindowMove"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 7), // "posDiff"
QT_MOC_LITERAL(4, 37, 20), // "sigLoadMoreCandidate"
QT_MOC_LITERAL(5, 58, 12) // "slotTimerOut"

    },
    "MyTableWidget\0sigWindowMove\0\0posDiff\0"
    "sigLoadMoreCandidate\0slotTimerOut"
};
...
void MyTableWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sigWindowMove((*reinterpret_cast< QPoint(*)>(_a[1]))); break;
        case 1: _t->sigLoadMoreCandidate(); break;
        ...
        {
            using _t = void (MyTableWidget::*)(QPoint );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyTableWidget::sigWindowMove)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (MyTableWidget::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyTableWidget::sigLoadMoreCandidate)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void MyTableWidget::sigWindowMove(QPoint _t1)
{
...
// SIGNAL 1
void MyTableWidget::sigLoadMoreCandidate()
{
