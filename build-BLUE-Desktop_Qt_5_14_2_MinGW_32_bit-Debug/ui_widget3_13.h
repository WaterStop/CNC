/********************************************************************************
** Form generated from reading UI file 'widget3_13.ui'
**
...
#ifndef UI_WIDGET3_13_H
#define UI_WIDGET3_13_H
...
public:
    ...
    void setupUi(QWidget *widget3_13)
    {
        if (widget3_13->objectName().isEmpty())
            widget3_13->setObjectName(QString::fromUtf8("widget3_13"));
        widget3_13->resize(293, 430);
        frame = new QFrame(widget3_13);
...
"background-color: rgb(64, 86, 129);"));
        ...
        bt_b_0->setGeometry(QRect(90, 340, 65, 35));
...
"background-color: rgb(64, 86, 129);"));
        ...
        retranslateUi(widget3_13);

        QMetaObject::connectSlotsByName(widget3_13);
    } // setupUi

    void retranslateUi(QWidget *widget3_13)
    {
        widget3_13->setWindowTitle(QCoreApplication::translate("widget3_13", "Form", nullptr));
...
namespace Ui {
    class widget3_13: public Ui_widget3_13 {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_WIDGET3_13_H
