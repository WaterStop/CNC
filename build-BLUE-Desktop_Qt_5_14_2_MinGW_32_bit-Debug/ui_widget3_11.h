/********************************************************************************
** Form generated from reading UI file 'widget3_11.ui'
**
...
#ifndef UI_WIDGET3_11_H
#define UI_WIDGET3_11_H
...
public:
    ...
    void setupUi(QWidget *widget3_11)
    {
        if (widget3_11->objectName().isEmpty())
            widget3_11->setObjectName(QString::fromUtf8("widget3_11"));
        widget3_11->resize(293, 430);
        frame = new QFrame(widget3_11);
...
"background-color: rgb(64, 86, 129);"));
        ...
        retranslateUi(widget3_11);

        QMetaObject::connectSlotsByName(widget3_11);
    } // setupUi

    void retranslateUi(QWidget *widget3_11)
    {
        widget3_11->setWindowTitle(QCoreApplication::translate("widget3_11", "Form", nullptr));
...
namespace Ui {
    class widget3_11: public Ui_widget3_11 {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_WIDGET3_11_H
